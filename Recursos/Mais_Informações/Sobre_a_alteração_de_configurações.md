# Sobre a alteração de configurações
...
Nenhuma alteração “perigosa” ou além do necessário é feita aqui, todo o script foi feito e testado para que absolutamente todos os recursos funcionem bem para 99.9% dos usuários.

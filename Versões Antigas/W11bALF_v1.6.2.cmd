...
if !n!==3 set "prog=%fgy1%─%fgy2%─%fgy3%─%fgy4%─%fgy5%─%fgy0%─"& echo [1A%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%reset%
if !n!==4 set "prog=%fgy0%─%fgy1%─%fgy2%─%fgy3%─%fgy4%─%fgy5%─"& echo [1A%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%prog%%reset%
goto:eof
